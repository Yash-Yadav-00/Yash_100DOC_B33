...
int main(){
    ...
    printf("Enter a number between 1 to 12: ");            //Take Input from User
    scanf("%d",&month);

    switch(month) {                            //Switch Case's for Output
    ...
    break;
    default: printf("Please enter a number between 1 to 12") ;  //If someone Enters a number not between 1-12 it prints this line
    }
